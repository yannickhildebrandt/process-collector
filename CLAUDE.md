...
- 003-interview-enhancements: Added TypeScript 5.x, Node.js 22+ + Next.js 16.1.6, React 19, Vercel AI SDK v6 (`ai`, `@ai-sdk/react`, `@ai-sdk/anthropic`), Prisma 6, bpmn-js 18, next-intl 4, Zod 4, Better Auth
- 002-ai-guided-interview: Added TypeScript 5.x, Node.js 18+ + Next.js 16 (App Router), Vercel AI SDK (`ai` + `@ai-sdk/anthropic`), bpmn-moddle, bpmn-auto-layout, zod, Prisma 6
